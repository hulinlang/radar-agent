...
> 标识 **tool6** ｜ 适配器 `F:/Qwen3-2B/radar-agent/outputs/p5_lora/p5b_tool6` ｜ 生成上限 256 token ｜ 耗时 1111s
...
| 题型 | n | 期望工具 | 调用率 | 工具选对 |
|---|---|---|---|---|
| concept | 67 | corpus_search | 97% | **96%** |
| calc | 30 | calc | 100% | **100%** |
| choice | 29 | corpus_search | 100% | **93%** |
| term | 22 | corpus_search | 100% | **100%** |
| unanswerable | 19 | corpus_search | 84% | **79%** |
