...
| `p3_eval_ch01_a.yaml` | 15 | evt_000554–evt_000568 | concept×8 / choice×3 / term×2 / unanswerable×2 | 2 | **0** |
...
| `p3_eval_ch06_a.yaml` | 23 | evt_000531–evt_000553 | concept×15 / choice×4 / term×2 / unanswerable×2 | 2 | **0** |
| `p3_eval_ch07_a.yaml` | 27 | evt_000504–evt_000530 | concept×12 / choice×5 / term×4 / calc×3 / unanswerable×2 / regime_trap×1 | 2 | **0** |
| `p3_eval_mm_a.yaml` | 28 | evt_000476–evt_000503 | calc×6 / concept×6 / term×4 / choice×4 / unanswerable×4 / contrast×2 / clarify×2 | 4 | **0** |
| `p3_eval_mm_b.yaml` | 15 | evt_000569–evt_000583 | concept×7 / choice×3 / term×2 / calc×1 / unanswerable×1 / clarify×1 | 1 | **0** |
...
| `p3_vis_exp1.yaml` | 15 | vis_000480–vis_000494 | readout×7 / figure_qa×7 / trend×1 | 0 | **0** |
| `p3_vis_exp2.yaml` | 15 | vis_000495–vis_000509 | readout×6 / figure_qa×6 / trend×3 | 0 | **0** |
| `p3_vis_exp3.yaml` | 14 | vis_000510–vis_000523 | readout×8 / figure_qa×6 | 0 | **0** |
| `p3_vis_exp4.yaml` | 25 | vis_000524–vis_000548 | figure_qa×13 / readout×12 | 0 | **0** |
| `p3_vis_exp5.yaml` | 24 | vis_000549–vis_000572 | figure_qa×16 / readout×8 | 0 | **0** |
| `p3_vis_exp6.yaml` | 20 | vis_000573–vis_000592 | figure_qa×17 / readout×3 | 0 | **0** |
...
|---|---|---|---|---|
| `calc` | 245 | 200 | +45 | 122% |
| `concept` | 318 | 250 | +68 | 127% |
| `term` | 133 | 110 | +23 | 121% |
| `choice` | 164 | 130 | +34 | 126% |
| `regime_trap` | 84 | 70 | +14 | 120% |
| `contrast` | 71 | 60 | +11 | 118% |
| `unanswerable` | 62 | 40 | +22 | 155% |
| `clarify` | 23 | 20 | +3 | 115% |
| 视觉 4 类 | 221 | 83 | 0 | 266% |
...
- `detection` 151 (11%)
- `doppler` 124 (9%)
- `pulse_compression` 121 (9%)
- `clutter` 120 (9%)
- `array_processing` 112 (8%)
- `radar_equation` 110 (8%)
- `resolution` 97 (7%)
- `tracking` 79 (6%)
- `imaging` 67 (5%)
...
**全部命中 ✓**（1308 条带 quote 的题都在语料里找到了原文）
