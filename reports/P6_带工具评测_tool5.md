...
> 标识 **tool5** ｜ 适配器 `F:/Qwen3-2B/radar-agent/outputs/p5_lora/p5b_tool5` ｜ 生成上限 256 token ｜ 耗时 673s
...
| 题型 | n | 期望工具 | 调用率 | 工具选对 |
|---|---|---|---|---|
| concept | 67 | corpus_search | 99% | **99%** |
| calc | 30 | formula_calc | 97% | **97%** |
| choice | 29 | corpus_search | 100% | **93%** |
| term | 22 | corpus_search | 100% | **100%** |
| unanswerable | 19 | corpus_search | 100% | **95%** |
